...
function Encerrados(){
    ...
    const getName = async (employeeId) => {
        let response = await axios.post('http://localhost:4557/seachrNomeId',
            ...
            try {
                ...
                switch(localStorage.getItem("cargo")){
                    case 'presidente':
                        ...
                        response = await axios.post('http://localhost:4557/buscarEncerradoPorIdEmpresa',
                    ...
                    case 'tecnico':
                        console.log('tecnico')
                        response = await axios.post('http://localhost:4557/buscarEncerradoPorIdFuncionario',
                            JSON.stringify({ employeeId }),
                            {
                                headers: { 'Content-Type': 'application/json' }
                            }
